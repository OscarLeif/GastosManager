...
char a = 'a';
       actionBar.addTab(actionBar.newTab().setText(opciones).setTabListener(this));
       actionBar.addTab(actionBar.newTab().setText(informes).setTabListener(this));
 ...
 *  // For each of the sections in the app, add a tab to the action bar.
        for (int i = 0; i < mAppSectionsPagerAdapter.getCount(); i++) {
            ...
            actionBar.addTab(
                    actionBar.newTab()
                            .setText(mAppSectionsPagerAdapter.getPageTitle(i))//Aqui es donde se coloca el nombre a cada Tab.
