...
import com.example.ingresosygastos.TablayoutActivity;
...
protected void onResume() {
	...
	public void agregarLista()
	{
		...
		//ArrayList<Usuario> actividad = ModelContainer.actividad.ListaUsuarios();
		//ArrayAdapter<Usuario> adaptador = new ArrayAdapter<Usuario>(this,android.R.layout.simple_list_item_1,actividad);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menuAgregar:
			Intent register = new Intent(MainActivity.this,Nuevo_usuario_Activity.class);
	...
	public void indiceLista()
	{
     ...
     {
	     //Cursor o =(Cursor) listaCuentas.getItemAtPosition(position);
